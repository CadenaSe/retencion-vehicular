...
<div class="d-flex flex-column border-end border-3 flex-shrink-0 bg-body-tertiary p-3 sticky" style="width: 280px; height: 100vh; position: fixed; z-index: 100">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li class="nav-item">
            <a href="http://localhost/retencion-vehicular/admin?action=registrosDashboard" class="nav-link active">
                Registros
            </a>
        </li>
        <li class="nav-item">
...
<div class="modal fade" id="agregarModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formAgregarRegistro" action="http://localhost/retencion-vehicular/admin?action=agregarRegistro" method="POST">
...
<div class="modal fade" id="editaModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formEditarRegistro" action="http://localhost/retencion-vehicular/admin?action=editarRegistro" method="POST">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="border rounded p-2">
                            <?php foreach ($listaActividades as $actividad): ?>
                                <div class="form-check">
                                    <input class="form-check-input actividad-checkbox-editar" type="checkbox" name="actividades[]"
                    ...
                    <div class="mb-3">
                        <label for="id_forma_pago_editar" class="form-label fw-semibold">Forma de pago (opcional):</label>
...
<div class="modal fade" id="deleteModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formEliminarRegistro" action="http://localhost/retencion-vehicular/admin?action=eliminarRegistro" method="POST">
                <div class="modal-body">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.querySelectorAll(".btn-editar").forEach(button => {
            button.addEventListener("click", function () {
                ...
                document.querySelectorAll(".actividad-checkbox-editar").forEach(checkbox => {
