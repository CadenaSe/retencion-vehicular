...
<div class="d-flex flex-column border-end border-3 flex-shrink-0 bg-body-tertiary p-3 sticky" style="width: 280px; height: 100vh; position: fixed; z-index: 100">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
            <a href="http://localhost/retencion-vehicular/admin?action=propietariosDashboard" class="nav-link active">
                Propietarios
            </a>
        </li>
        <li class="nav-item">
...
<div class="modal fade" id="agregarModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formAgregarPropietario" action="http://localhost/retencion-vehicular/admin?action=agregarPropietario" method="POST">
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="cedula" class="form-label">Cédula</label>
                        <input minlength="10" maxlength="10"    type="text" name="cedula" id="cedula" placeholder="Ingrese N° de Cédula"  class="form-control" pattern="[0-9]+" required="">
                    </div>
                    <div class="mb-3">
                        <label for="nombres" class="form-label">Nombres</label>
                        <input type="text"   name="nombres" id="nombres" placeholder="Ingrese nombres"  class="form-control" pattern="[a-z-A-Z]"  required="">
                    </div>
                    <div class="mb-3">
                        <label for="apellidos" class="form-label">Apellidos</label>
                        <input type="text" name="apellidos" id="apellidos" placeholder="Ingrese apellidos" class="form-control" pattern="[a-z-A-Z]" required="">
                    </div>
                    <div class="mb-3">
                        <label for="telefono" class="form-label">Teléfono</label>
                        <input minlength="10" maxlength="10"  type="text" name="telefono" id="telefono" placeholder="Ingrese telefono" class="form-control" pattern="[0-9]+" required="">
                    </div>
                    <div class="mb-3">
...
<div class="modal fade" id="editarModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formEditarPropietario" action="http://localhost/retencion-vehicular/admin?action=editarPropietario" method="POST">
                <div class="modal-body">
                    <div class="mb-3">
...
<div class="modal fade" id="deleteModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formEliminarPropietario" action="http://localhost/retencion-vehicular/admin?action=eliminarPropietario" method="POST">
                <div class="modal-body">
