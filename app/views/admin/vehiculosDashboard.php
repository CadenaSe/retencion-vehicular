...
<div class="d-flex flex-column border-end border-3 flex-shrink-0 bg-body-tertiary p-3 sticky" style="width: 280px; height: 100vh; position: fixed; z-index: 100">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li class="nav-item">
            <a href="http://localhost/retencion-vehicular/admin?action=vehiculosDashboard" class="nav-link active">
                Vehículos
            </a>
        </li>
        <li class="nav-item">
...
<div class="modal fade" id="agregarModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formAgregarVehiculo" action="http://localhost/retencion-vehicular/admin?action=agregarVehiculo" method="POST">
                <div class="modal-body">
                    <!-- Placa -->
                    <div class="mb-3">
                        <label for="placa" class="form-label">Placa</label>
                        <input minlength="7" maxlength="7" type="text" name="placa" id="placa" class="form-control" placeholder="Ingrese placa del vehiculo" required>
                    </div>

                    <!-- Año -->
                    <div class="mb-3">
                        <label for="anio" class="form-label">Año</label>
                        <input minlength="4" maxlength="4" type="text" name="anio" id="anio" class="form-control" placeholder="Ingrese año"  pattern="[0-9]+" required>
                    </div>
...
<div class="modal fade" id="editaModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formEditarVehiculo" action="http://localhost/retencion-vehicular/admin?action=editarVehiculo" method="POST">
                <div class="modal-body">
                    <!-- Placa (No editable) -->
                    <div class="mb-3">
...
<div class="modal fade" id="deleteModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formEliminarVehiculo" action="http://localhost/retencion-vehicular/admin?action=eliminarVehiculo" method="POST">
                <div class="modal-body">
