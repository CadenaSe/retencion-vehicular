...
$marcasLista = $marcaController->listar();
?>
...
<div class="d-flex flex-column border-end border-3 flex-shrink-0 bg-body-tertiary p-3 sticky" style="width: 280px; height: 100vh; position: fixed; z-index: 100">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li class="nav-item">
            <a href="http://localhost/retencion-vehicular/admin?action=marcasDashboard" class="nav-link active">
                Marcas
            </a>
        </li>
        <li class="nav-item">
...
<div class="container" style="margin: 50px 50px 50px 325px">
    <h2 class="text-center">Dashboard de marcas</h2>
    <p class="my-3">Esta es la sección principal donde podrás ver la información de las marcas.</p>
    <div class="row my-2 pb-5">
        <div class="col-md-12 my-2">
            <div class="main-card mb-3 card">
                <div class="card-header fw-semibold p-3 text-center">Lista de marcas</div>
                <div class="table-responsive">
                    <table class="align-middle mb-0 table table-borderless table-hover table-striped">
                        ...
                        <?php if (empty($marcasLista)) { ?>
                            <tr>
                                <td class="text-center" colspan="4">No hay marcas</td>
                            </tr>
                        <?php } else { ?>
                            <?php foreach ($marcasLista as $index => $marca) { ?>
                                <tr>
                                    <td class="text-center text-muted"><?php echo $index + 1; ?></td>
                                    <td class="text-center"><?php echo $marca['codigo_marca']; ?></td>
                                    <td class="text-center"><?php echo $marca['detalle']; ?></td>
                                    <td class="text-center">
                                        <button type="button" class="btn btn-primary btn-sm btn-editar"
                                                data-codigo="<?php echo $marca['codigo_marca']; ?>"
                                                data-detalle="<?php echo $marca['detalle']; ?>"
                ...
                <div class="d-block text-center card-footer">
                    <a type="button" class="btn btn-success my-2" data-bs-toggle="modal" data-bs-target="#agregarModal">Agregar marca</a>
                </div>
            </div>
            <!-- Mensaje de error -->
...
<script>
        function limpiarCampos() {
            document.getElementById("formAgregarMarca").reset();
        }
    </script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">Agregar Marca</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="formAgregarMarca" action="http://localhost/retencion-vehicular/admin?action=agregarMarca" method="POST">
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="codigo_marca" class="form-label">Código Marca</label>
                        <input minlength="6" maxlength="6" type="text" name="codigo_marca" id="codigo_marca" class="form-control" placeholder="Ingrese código de marca" required>
                    </div>
                    <div class="mb-3">
...
<div class="modal fade" id="editaModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formEditarMarca" action="http://localhost/retencion-vehicular/admin?action=editarMarca" method="POST">
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="codigo_editar" class="form-label">Código Marca</label>
                        <input type="text" name="codigo_marca" id="codigo_editar" class="form-control" required readonly>
                    </div>
                    <div class="mb-3">
...
<div class="modal fade" id="deleteModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="formEliminarMarca" action="http://localhost/retencion-vehicular/admin?action=eliminarMarca" method="POST">
                <div class="modal-body">
                    <p>¿Estás seguro de que deseas eliminar esta marca?</p>
                    <input type="hidden" name="codigo_marca" id="codigo_eliminar">
                </div>
                <div class="modal-footer">
