...
<main class="form-signin w-100">
    <form action="http://localhost/retencion-vehicular/operador?action=login" method="POST">
        <div class="d-flex flex-row align-items-center justify-content-between">
            <h1 class="h3 mb-3 fw-normal">Ingresar como Operador</h1>
            <i class='bx bx-cog my-2' style="font-size: 50px"></i>
        </div>
        <div class="form-floating my-2">
            <input type="text" class="form-control" id="username" name="username" placeholder="Operador">
